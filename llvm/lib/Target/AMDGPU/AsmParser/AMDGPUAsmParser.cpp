...
public:
  ...
  bool isVCSrcV2FP32() const { return isVCSrcF64(); }

  bool isVSrc_v2f32() const { return isVSrc_f64() || isLiteralImm(MVT::v2f32); }

  bool isVCSrcV2INT32() const { return isVCSrcB64(); }
...
bool AMDGPUAsmParser::validateInstruction(const MCInst &Inst,
  ...
  if (!validateSOPLiteral(Inst)) {
    Error(getLitLoc(Operands), "only one unique literal operand is allowed");
    return false;
  }
